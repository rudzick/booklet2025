...
\noindent\abstractOther{%
  ...
  GeoStyler besetzt durch seine Stilkonverter eine Nische in der Webkartographie und konnte sich so
  in den letzten Jahren in der Open Source Community etablieren. Um User bei der Entscheidung zu
  unterstützen, ob und wie GeoStyler für sie von Nutzen sein kann, führen wir in diesem Talk einen
  visuellen Vergleich der unterstützten Stilformate anhand einiger Beispielkarten durch.
  Gleichzeitig zeigen wir damit auf, wo es noch Verbesserungsbedarf gibt. Dieser Talk ist ein Call
  for Participation.%
}%
{%
  Hörsaal 1 (Audimax 1)%
...
\noindent\abstractOther{%
  Qasem Safariallahkheili, Prof. Dr. Sebastian Meier%
}{%
