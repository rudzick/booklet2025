...
\input{sponsorentexte/201-hbt.tex}
...
\input{sponsorentexte/402-terrestris.tex}
...
\input{sponsorentexte/403-mundialis.tex}
...
\input{sponsorentexte/404-52north.tex}
...
\input{sponsorentexte/405-conet.tex}
...
%
\newpage
\newLightningTimeslot{18:15}
\noindent\abstractHSdrei{%
  Marc Jansen%
}{%
  ol-describe-map: Mehr Web-Accessibility für OpenLayers\linebreak Karten%
}{%
}{%
  In diesem Lightning Talk möchte ich die ol-describe-map-Bib\-lio\-thek vorstellen und erläutern, wie
...
\noindent\abstractHSdrei{%
  ...
  Die Programmiersprache Go hat sich in verschiedenen IT-Be\-rei\-chen etabliert. Dieser Lightning Talk
