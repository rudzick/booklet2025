...
\noindent\abstractHSAnatomie{%
  ...
  Was ist OpenStreetMap? Was ist OpenStreetMap? Was ist OpenStreetMap? Was ist OpenStreetMap? Was
  ist OpenStreetMap?%
}%
...
\noindent\abstractHSRundbau{%
  ...
  Eine feierliche Eröffnung der Konferenz durch Vertreter des FOSSGIS e.V. mit wertvollen Hinweisen
  zum Ablauf und der Organisation%
}%
...
% URL: https://pretalx.com/fossgis2020/talk/TNKAUM/
...
\noindent\abstractHSRundbau{%
  ...
  Wie man offene Geodaten bekommt, jetzt! Meine Erfahrung in Luxemburg, in der EU und ausserhalb.%
}{%
}{%
  * Data.public.l

  * PSI/open data Richtlini

  * Kosovo~-- what's in it for me


  Platzhalter um Platz zu halten Platzhalter um Platz zu halten%
}%
...
\noindent\abstractHSAnatomie{%
  ...
  Die Webkarten des neuen Vogelatlas der Schweizer Vogelwarte bieten dank Vector Tile Technologie
...
\noindent\abstractHSRundbau{%
  ...
  Vortrag beschreibt die unterschiedlichen Vorgehensweisen und stellt Vor- und Nachteile einzelnen
  Verfahren gegenüber.%
}%
...
\noindent\abstractHSAnatomie{%
  ...
  genutzt, um diese Lösungen über ein einheitliches User-Interface einzubinden und Routing-Anfragen
  zu stellen und visuell in der Webkarte darzustellen.  Hierbei werden auf die unterschiedlichen
...
\noindent\abstractHSRundbau{%
  ...
  Speziell für den Umgang mit OpenStreetMap-Daten liegen einige Möglichkeiten vor. Diese werden
...
\noindent\abstractHSRundbau{%
  ...
  Gebäude können sehr lang gestreckt sein. Und da sie nicht immer in die gleiche Richtung verlaufen,
...
\noindent\abstractHSRundbau{%
  ...
  Open-Source-Lizenz veröffentlicht wurden. Die Node.js-Bibliotheken ermöglichen die Administration
