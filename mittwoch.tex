...
\noindent\abstractHSeins{%
  ...
  Der Parlamentarische Staatssekretär im Ministerium für Heimat, Kommunales, Bau und Digitalisierung
  des Landes Nordrhein-Westfalen, Josef Hovenjuergen ist für Begrüßungsworte sowie einen
  Keynotebeitrag im Rahmen der Eröffnung angefragt.%
}%
...
\newTimeslot{10:30}
\noindent\abstractHSeins{%
  Katja Haferkorn, Maik, Christopher Lorenz%
}{%
  ...
  Angelehnt ans Lightningtalk-Format wird ein Feuerwerk aus 25ig Jahren FOSSGIS e.V. gezündet,
...
\noindent\abstractHSzwei{%
  ...
  [**spatial.IO**](https://doi.org/10.5281/zenodo.10391523) des Helmholtz-Zentrums für
...
\noindent\abstractHSvier{%
  ...
  Hintergrund der OpenData-Bereitstellung des LVermGeo Rheinland-Pfalz steigt nun auch das Interesse
...
\noindent\abstractHSzwei{%
  ...
  skalierbaren Geodateninfrastruktur auf Grundlage der STAC-Spezifikation. eoAPI ermöglicht die
...
\noindent\abstractHSdrei{%
  ...
  Werkzeuge wie z.B. \_GDAL, QGIS, OSM und LaTeX\_ eingesetzt.%
}%
...
\noindent\abstractHSdrei{%
  ...
  Mistral-large wurden getestet und dabei herausgefunden, dass ein hybrider Open-Source-Ansatz bis
...
\noindent\abstractHSdrei{%
  ...
  Im Rahmen der aktuellen Diskussion zur Nutzung von KI-Sprachmodellen untersuchen wir in einem
