...
\noindent\abstractHSeins{%
  ...
  Zensus-Daten und vieles mehr. Die Daten werden in einer mit Open Source Software implementieren
  Architektur tagesaktuell automatisiert verarbeitet und als VectorTile Archive mit Styling,
  Rasterkachel-Dienste, GeoPackages (nur OpenData Länder) und mit dem selbstentwickelten
...
\noindent\abstractHSeins{%
  ...
  Vor über 10 Jahren war OpenLayers die 1. Wahl unter den spärlich verfügbaren Web Mapping
  Libraries. Ein Rewrite im Jahr 2012 und die zunehmende Verbreitung von Leaflet and Mapbox GL JS
  haben zu einem spürbaren Verlust an Popularität geführt. Heute bedient OpenLayers ein bisschen
  mehr als eine Nische als Mapping Library mit den meisten Features und der größten Flexibilität bei
...
\noindent\abstractHSdrei{%
  Dr. Christopher Frank, Dr. Alexander Willner%
}{%
...
\vspace{1.92\baselineskip}
\input{sponsorentexte/401-komoot}%
...
\noindent\abstractHSzwei{%
  ...
  frei verfügbaren Geodaten präsentieren wir eine explorative ortsbezogene Geomodellierung und
  -analyse, um verschiedene Perspektiven auf Mobilität im Kontext der Mobilitätswende zu ergründen,
  die über traditionelle GISysteme hinausgehen.%
}%
...
\noindent\abstractHSdrei{%
  ...
  unverfügbar zu machen. Als freiberuflicher Geodaten\_Dienstleister, der in2022 umfangreiche
...
\vspace{1.92\baselineskip}
\input{sponsorentexte/201-terrestris}%
...
\noindent\abstractHSzwei{%
  ...
  GeoStyler ist eine Open Source JavaScript-Bibliothek zum Konvertieren zwischen Styling-Formaten
...
\vspace{1.92\baselineskip}
\input{sponsorentexte/403-sourcepole}%
...
\noindent\abstractHSdrei{%
  ...
  Vollständigkeitsabschätzung von\linebreak Gebäuden in OSM mit dem Global Human Settlement Layer%
}{%
}{%
  Die Qualitätsbewertung, inklusive Vollständigheitsabschätzung, ist ein bedeutender Prozess bei
  ...
  Quadtree-Kacheln projiziert und mit der entsprechenden Größe der Gebäudepolygone in OSM
  verglichen. Mit den `minutely diffs` von OSM bietet das System ein aktuelle und weltumspannende
  Vollständigheitsabschätzung.%
}%
...
\noindent\abstractExpBoFAnw{%
  ...
  Austausch. Das nächste Treffen soll auf der FOSSGIS 2023 stattfinden. Leider ist das Treffen nur
  sehr kurz. Die Zeit soll genutzt werden, um die mit der Umstellung auf die GeoInfoDok 7
  anstehenden Änderungen durchzusprechen. Einsteiger und Interessierte sind auch willkommen und
  können im Nachgang Informationen versorgt werden. Fragen können dann durch die zahlreichen
  PostNAS-Suite-Anwender beantwortet werden%
}%
%\vspace{1.0\baselineskip}
\input{sponsorentexte/202-schneider-digital}%
