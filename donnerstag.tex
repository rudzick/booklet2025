...
%}{%
%}{%
%  Um schwungvoll in den Konferenztag zu kommen, wird Hanna Krüger eine Session Yoga und Pilates anbieten.
%}%
%{%
%  Ort siehe Aushang%
%}%
...
Der Rheinland-Pfalz-Tag 2019 in Annweiler%
}{%
...
\noindent\abstractHSAnatomie{%
  ...
  \emph{Demo-Session:} Visualisierung und Analyse von Satelliten\-bildern mit der EnMAP-Box%
}{%
}{%
...
\noindent\abstractHSRundbau{%
  ...
  Aufbereitung von vektorbasierten Geo\-daten als Grundlage für Landnutzungs\-modelle mit QGIS und Postgis%
}{%
}{%
...
\noindent\abstractHSAnatomie{%
  ...
  Offene Smart-Farming-Produkte aus\linebreak offenen Satellitendaten%
}{%
}{%
...
\noindent\abstractWeismannhaus{%
  ...
  Neben Routing und dem Erzeugen von Karten ist die Darstellung sogenannter Points of
  Interest (POI) eine häufige Anwendung von OpenStreetMap. Im Vortrag zeige ich, wie man ein Backend für solche POI-Karten einfach selbst aufsetzen und
  betreiben kann.%
}%
...
\input{sponsorentexte/205-disy.tex}
...
\noindent\abstractWeismannhaus{%
  ...
  Gefahrenbewertung im Radverkehr \mbox{mittels} Crowdsourcing von \mbox{Geoinformationen}~\noVideo%
}{%
}{%
...
\input{sponsorentexte/106-db-mindbox.tex}
...
\noindent\abstractWeismannhaus{%
  ...
  Entwicklung des Berliner Radverkehrs anhand von öffentlich gemachten \mbox{Verkehrszähldaten}~\noVideo%
}{%
}{%
...
\input{sponsorentexte/105-kuestenschmiede.tex}
...
\noindent\abstractHSRundbau{%
  ...
  Map Editor für individuelle amtliche \mbox{Vektorkarten}%
}{%
}{%
...
\noindent\abstractWeismannhaus{%
  ...
  \begin{itemize}
    ...
    \item \emph{Johannes Kröger:} Leider immer noch kein LiDAR?
    \item \emph{Christopher Lorenz:} Bikeparking~-- Vergleich von Fahradparkplätzen zwischen Open Data und OpenStreetMap
    \item \emph{Florian Thiery, Timo Homburg:} QGIS~-- A SPARQLing Unicorn? Eine Einführung in Linked Open Geodata zur Integration von RDF in QGIS Plugins
  \end{itemize}
  \justifying
}%
...
\noindent\abstractWeismannhaus{%
  Svenja Ruthmann, Alexander Rolwes,\linebreak
  Klaus Böhm%
}{%
...
\noindent\abstractWeismannhaus{%
  ...
  \begin{itemize}
    \RaggedRight
    \setlength{\itemsep}{-4pt} % Aufzählungspunktabstand auf 0
    \item \emph{Thomas Skowron:} Triff OSMler in deiner Nähe mit OSMCAL
    \item \emph{Robert Klemm, Michael Spreng:} Neues vom Fossgis Routing Server
    \item \emph{Astrid Emde, Miriam Gonzalez:} Geochicas OSM stellen sich vor
    \item \emph{Athina Trakas:} Women in Geospatial+~-- Ein professionelles Netzwerk für Frauen in der GIS-/Geo-Industrie
  \end{itemize}
  \justifying
}%
...
\noindent\abstractHSRundbau{%
  ...
  Mit Wegue lassen sich Web-GIS-Anwendungen durch eine einfache Konfigurationsdatei erstellen. Es
...
\input{sponsorentexte/208-geofabrik.tex}
...
\noindent\abstractHSRundbau{%
  ...
  Javascript-Bibliotheken zur Einbindung von historischen Umwelt- und Klima\-informationen als Kartenlayer%
}{%
}{%
  \emph{www.tambora.org} bietet über 250\,000 historische Einträge zum Thema Umwelt- und Klima,
...
\noindent\abstractWeismannhaus{%
  ...
  Automatische Korrektur von \mbox{ÖV-Stationen} in OSM%
}{%
}{%
  Stationen des öffentlichen Verkehrs bestehen üblicherweise aus mehreren Punkt-, Linien- oder Flächeninformationen, z.\,B.
  ...
  Wir stellen ein Tool vor, das die Elemente von ÖV-Stationen als Paare von
...
\input{sponsorentexte/202-wagner-it.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\input{sponsorentexte/104-regiodata.tex}
