...
\noindent\abstractHSRundbau{%
  ...
  Vorbereitung einer Großveranstaltung mit QGIS und QField~-- Der Rheinland-Pfalztag 2019 in Annweiler%
}{%
}{%
  Es wird die Unterstützung der Vorbereitung des Rheinland-Pfalztages in Annweiler 2019 von der
  Aufnahme des Straßenmobiliars mit de Trimble Catalyst GPS bis hin zur Erzeugung der
...
\noindent\abstractWeismannhaus{%
  ...
  Dieser Vortrag demonstriert anhand von praktischen Beispielen, wie man eigene Tools zu

  Datenaufbereitung schreiben kann. Er erklärt die Besonderheiten de
...
\noindent\abstractWeismannhaus{%
  ...
  OSM-Daten mit Vectortiles erfolgreich nutzen%
}{%
}{%
  Das OpenMapTile-Projekt bietet zahlreiche Möglichkeiten für den Umgang mit Vektor- und Rasterdaten


  Speziell für den Umgang eines Kartendienstes aus OpenStreetMap-Daten werden verschiedene Lösungen
  bereitgestellt.


  Dieser Vortrag bietet einen Überblick über den Einsatz und Prozessierung bis zur Einbindung von
  Vektortiles in einer Webkarte.%
}%
...
\noindent\abstractHSRundbau{%
  ...
  Vektorverschneidung gehört zu den grundlegenden GIS-Analysefunktionen. Dennoch kommt es in der
...
\noindent\abstractWeismannhaus{%
  ...
  Interest (POI) eine häufige Anwendung von Openstreetmap dar

  Im Vortrag zeige ich wie man ein Backend für solche POI Karten einfach selbst aufsetzen und
  betreiben kann.%
}%
...
\noindent\abstractWeismannhaus{%
  ...
  Unfallstatistiken sowie weiteren Geodaten wird gezeigt, wie auf einer solchen Geodatenbasis
  Sicherheitsaspekte für Radfahrer neu bewertet werden können.%
}%
...
\noindent\abstractHSAnatomie{%
  ...
  Vereinheitlichtung diverser vorhandener OGC-Standards entwickelt. Neu war nicht nur der offene
  Prozess, sondern auch mehrere Umsetzungen bereits während der Entwurfsphase. Das Resultat namens
  "`OGC API~-- Features~-- Part 1: Core"' ist ein zeitgemässer und schlanker Standard, welcher zwar noch
...
\noindent\abstractHSRundbau{%
  ...
  Freie Geodaten der Umweltverwaltung Bayern~-- Hintergründe und einfache Anwendungsbeispiele%
}{%
}{%
  Entsprechend des Bayerischen Umweltinformationsgesetzes (BayUIG) und des Bayerisches
  Geodateninfrastrukturgesetz (BayGDIG) stellt die Bayerische Umweltverwaltung Geodaten unter der
  freien Lizenz CC-BY 3.0 zur Verfügung. In dem Vortrag werden die gesetzlichen Grundlagen und
  gebräuchliche Lizenzen (Creative Commons CC, Datenlizenz Deutschland, ...) am Beispiel von
...
\noindent\abstractHSRundbau{%
  ...
  Kartenanwendungen, basierend auf Vector Tiles. Die Anwendung bietet Werkzeuge zur Anpassung und
...
% time: Thursday 12:00
% URL: https://pretalx.com/fossgis2020/talk/RQMALK/
...
\noindent\abstractWeismannhaus{%
  ...
  Ich erzähle kurz zum aktuellen Stand der Dinge in meinen Bestrebungen amtliche LiDAR-Daten bzw.
  das digitale Oberflächenmodell der Stadt Hamburg über das Hamburgische Transparenzgesetz zu
  befreien.%
}%
...
% time: Thursday 12:05
% URL: https://pretalx.com/fossgis2020/talk/UZQF9G/
...
\noindent\abstractWeismannhaus{%
  ...
  In diesem Lightning Talk wird kurz meine Auswertung zum Thema Fahrradparkplätze in OpenStreetMap
  vorgestellt. Dabei werden die in OpenStreetMap vorhandenen Daten mit öffentlich zur Verfügung
...
% time: Thursday 12:10
% URL: https://pretalx.com/fossgis2020/talk/SQDQHJ/
...
\noindent\abstractWeismannhaus{%
  ...
  Die *Linked Open Data Cloud* bietet freie interdisziplinäre Daten als *RDF* im WWW an. Auch
  Geodaten werden durch *Wikidata* oder *LinkedGeoData* zur Verfügung gestellt. Es fehlt jedoch der
  Support von GIS Applikationen zur Verarbeitung dieser LOD. Das **[SPARQLing Unicorn QGIS
  Plugin](https://plugins.qgis.org/plugins/sparqlunicorn)** bietet die Möglichkeit SPARQL Abfragen
  an SPARQL Endpoints zu stellen und somit Linked Data in die Welt der freien Software *QGIS* zu
  integrieren.%
}%
...
\noindent\abstractHSAnatomie{%
  ...
  Analyse von Geodaten. Die neue Hauptversion präsentiert sich mit unzählige Detailverbesserungen in
...
\noindent\abstractHSAnatomie{%
  ...
  Über Foreign Data Wrapper können Verbindungen aus einer PostgreSQL-Datenbank heraus zu anderen
  ...
  der PostgreSQL-Datenbank befinden


  Mit unterschiedlichen Erweiterungen können Verbindungen von PostgreSQL zu Oracle, MySQL, CSV,
  JSON, Geodaten, OSM und vielen weite­ren Quellen geschaffen werden.%
}%
...
\noindent\abstractHSRundbau{%
  ...
  TEAM Engine: Vorstellung der neusten Tests für OGC Standards wie OGC API~-- Features oder GeoTIFF%
}{%
}{%
  ...
  der neuen OGC Standards OGC API~-- Features und GeoTIFF getestet werden können
...
\noindent\abstractHSRundbau{%
  ...
  deegree und die Unterstützung des neue Standards OGC API~-- Features ein.%
}%
...
% time: Thursday 14:30
% URL: https://pretalx.com/fossgis2020/talk/3BSTMC/
...
\noindent\abstractWeismannhaus{%
  ...
  Um die OSM-Community zusammenwachsen zu lassen, starteten wir den OSM Kalender. So kann man
  einfacher Veranstaltungen ankündigen, Anwesenheit signalisieren oder Veranstaltungen in der Nähe
  finden.%
}%
...
% time: Thursday 14:35
% URL: https://pretalx.com/fossgis2020/talk/GCFPVF/
...
\noindent\abstractWeismannhaus{%
  ...
  Der Dienst startete im 2018. Wie hat sich der Dienst unterdessen entwickelt. Wer nutzt ihn und wie
  viel wird er genutzt.%
}%
...
% time: Thursday 14:40
% URL: https://pretalx.com/fossgis2020/talk/P8ADRK/

%
\newTimeslot{14:40}
\noindent\abstractWeismannhaus{%
  Astrid Emde, Miriam Gonzalez%
}{%
  Geochicas OSM stellen sich vor%
}{%
}{%
  GeoChicas ist eine Gruppe von Frauen, die in OpenStreetMap mappen und darüber hinaus versuchen,
  das Geschlechtergefälle in OSM zu schließen
...
% time: Thursday 14:45
% URL: https://pretalx.com/fossgis2020/talk/WLXKQW/
...
\noindent\abstractWeismannhaus{%
  ...
  Women in Geospatial+ ist ein professionelles Netzwerk für Frauen in der GIS Industrie und
  Forschung. Gründing 2018/2019. Weltweit ca. 800 Mitglieder.%
}%
...
\noindent\abstractWeismannhaus{%
  ...
  PTNA: Qualitätssicherung für ÖPNV in OpenStreetMap%
}{%
}{%
  ...
  PTNA~-- Public Transport Network Analysis erlaubt zusätzlich im ersten Schritt eine
...
\noindent\abstractHSAnatomie{%
  ...
  Das OSGeo Datacube Community Project rasdaman%
}{%
}{%
  Die rasdaman ("raster data manager") Datacube Engine ist OGC Referenzimplementierung für den
  Rasterdaten-Standard WCS, mit über 28.000 Downloads der open-source rasdaman community. Wir
  stellen den aktuellen Stand des Systems vor und präsentieren Portale, welche rasdaman community
  nutzen.%
}%
...
\noindent\abstractHSRundbau{%
  ...
  www.tambora.org bietet über 250000 historische Einträge zum Thema Umwelt- und Klima,
  differenzierbar nach Zeit, Ort und thematischen Schwerpunkt. Durch die vorgestellten **Libraries**
  lassen sich diese einfach in eigene **leaflet**- oder **openlayer**-Karten  einbinden und reichern
