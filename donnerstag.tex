...
\noindent\abstractHSzwei{%
  ...
  Erreichbarkeitsanalyse in ländlichen\linebreak Räumen: Potenziale des Radverkehrs%
}{%
}{%
...
\noindent\abstractHSvier{%
  ...
  QField Plugins~-- Beispiele und Möglich\-keiten%
}{%
}{%
...
\noindent\abstractHSzwei{%
  ...
  DFS Deutsche Flugsicherung: Open Source und Sicherheit bei UAS? Ein Erfahrungs\-bericht%
}{%
}{%s
...
\noindent\abstractHSdrei{%
  ...
  Parkraumdaten aus OSM mit der\linebreak Verwaltung pflegen (Praxisbericht)%
}{%
}{%
