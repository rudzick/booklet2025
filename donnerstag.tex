...
\noindent\abstractHSdrei{%
  ...
  Ermittlung von Solarpotential\-flächen auf Gebäuden%
}{%
}{%
...
\input{sponsorentexte/406-dassau.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\input{sponsorentexte/407-grit.tex}
...
\input{sponsorentexte/408-latlon.tex}
