...
\noindent\begin{tabular}{Z{0.7cm}Z{3.0cm}Z{3.0cm}}
  ...
  \longTalk{2}{Kartografie-Verbesserungen, Tipps und Tricks in QGI \emph{(45 min)}}{Andreas Neumann}
  \tabularnewline
  10:10
...
\noindent\begin{tabular}{Z{0.7cm}Z{2.0cm}Z{2.0cm}Z{2.0cm}}
  ...
  \tabularnewline
09:00
  \talk{OpenStreetMap-Daten mit JOSM bearbeiten \emph{(90 min)}}{Michael Reichert}
  \talk{Mergin Maps Essentials \emph{(90 min)}}{Peter Petrik}
  \talk{EOC EO Products Service - Zugriff und Nutzung von Geodaten mit STAC \emph{(90 min)}}{Felix Feckler}
  \tabularnewline
  \end{tabular}
...
11:10
  ...
  \talk{QField in der Praxis - Feldarbeit leicht gemacht \emph{(90min)}}{Michael Schmuki, Berit Mohr}
  \tabularnewline
 \end{tabular}
