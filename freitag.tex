...
\input{sponsorentexte/411-komoot.tex}
...
\input{sponsorentexte/413-indiscale.tex}
...
%\vspace{0.1cm}
\input{sponsorentexte/412-norbit.tex}
...
\input{sponsorentexte/417-geofabrik.tex}
%\input{sponsorentexte/414-tomtom.tex}
...
\noindent\abstractHSvier{%
  ...
  Workflow zur Erstellung von Trainings\-daten für die KI-Gebäudeerkennung%
}{%
}{%
...
\input{sponsorentexte/419-lehmann.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\input{sponsorentexte/416-geops.tex}

\vspace{0.5cm}
\input{sponsorentexte/415-gkg-kassel.tex}
