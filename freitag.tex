...
\noindent\abstractHSdrei{%
  ...
  Verwendung von OSM-Daten zur\linebreak Kartierung des urbanen, öffentlichen Raums%
}{%
}{%
...
\noindent\abstractHSeins{%
  ...
  Aufbau einer Plattform für die\linebreak Risikobewertung von Biodiversitätsportfolios%
}{%
}{%
  ...
  Risiken in Bezug auf die biologische Vielfalt in Portfolios zu bewerten. Dabei werden Earth-Observation-Datenprodukte
  sowie Lieferketten- und Anlagendaten von börsennotierten Unternehmen
  genutzt.%
}%
...
\noindent\abstractHSvier{%
  ...
  OSS im schweizerischen ÖREB-Kataster: Erfahrungen und\linebreak technische Herausforderungen%
}{%
}{%
