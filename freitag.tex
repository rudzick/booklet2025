...
\input{sponsorentexte/201-mundialis.tex}
\pagebreak
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\vfill
\input{sponsorentexte/204-gkg-kassel.tex}
...
\noindent\abstractWeismannhaus{%
  ...
  Die folgenden Beiträge sind in diesem Block schon eingeplant:
  \begin{itemize}
    \RaggedRight
    \setlength{\itemsep}{-4pt} % Aufzählungspunktabstand auf 0
    \item \emph{Holger Bruch:} OSMRouteFix~-- Routen erfassen und\linebreak
    monitoren
    \item \emph{Robert Klemm:} Neues zum Lyrk-Mapstyle: Was kommt danach?
  \end{itemize}
  \justifying
  Weitere Lightning Talks können, sofern noch Platz verfügbar ist,
  angemeldet werden. Bitte beachten Sie auch die Aushänge.
}%
\newpage
\input{sponsorentexte/103-geoinfo.tex}

\vspace{1\baselineskip}
\input{sponsorentexte/206-bemastergis.tex}
...
\noindent\abstractHSAnatomie{%
  ...
  mindestens maßgeblich zu ergänzen. Dieser Vortrag zeigt, wie Vektortiles generiert werden können
...
\noindent\abstractHSRundbau{%
  ...
  an. Sie ist ein Beispiel einer vollständig personalisierten QGIS-Anwendung, die die leistungsstarke
...
\noindent\abstractWeismannhaus{%
  ...
  OpenStreetMap möglich sind, welche Hürden dabei überwunden werden müssen und, dass man nie aufgeben
...
\noindent\abstractWeismannhaus{%
  ...
  Rettungspunkte~-- Im Prinzip ganz einfach, aber \dots%
}{%
...
\input{sponsorentexte/404-yaga.tex}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \input{sponsorentexte/102-nti-cwsm.tex} Freitag

% \input{sponsorentexte/103-geoinfo.tex} Donnerstag

% \input{sponsorentexte/104-regiodata.tex} Donnerstag

% \input{sponsorentexte/105-kuestenschmiede.tex} Donnerstag

% \input{sponsorentexte/106-db-mindbox.tex} Donnerstag

%\input{sponsorentexte/201-mundialis.tex} Freitag

% \input{sponsorentexte/202-wagner-it.tex} Donnerstag

% \input{sponsorentexte/203-geoinformatik-buero-dassau.tex} Donnerstag

% \input{sponsorentexte/204-gkg-kassel.tex} Donnerstag

% \input{sponsorentexte/205-disy.tex} Donnerstag

%\input{sponsorentexte/206-bemastergis.tex} Freitag

% \input{sponsorentexte/207-mapwebbing.tex} Mittwoch

%\input{sponsorentexte/208-geofabrik.tex} Donnerstag

%\input{sponsorentexte/209-intevation.tex} Mittwoch

% \input{sponsorentexte/301-vag.tex} Mittwoch

%\input{sponsorentexte/401-tib.tex} Mittwoch

%\input{sponsorentexte/402-voc.tex} Mittwoch

%\input{sponsorentexte/403-osgeolive.tex} Donnerstag

%\input{sponsorentexte/404-yaga.tex} Mittwoch
