...
{%
  \setAbstract{#1}{#2}{#3}{#4}{geoblau}{Hörsaal 1 (0\textquotesingle 115)}
}

% abstract at HS 2
\DeclareRobustCommand*{\abstractHSzwei}[4]%
{%
  \setAbstract{#1}{#2}{#3}{#4}{hellgelb}{Hörsaal 2 (0\textquotesingle 110)}
}

% abstract at HS 3
\DeclareRobustCommand*{\abstractHSdrei}[4]%
{%
  \setAbstract{#1}{#2}{#3}{#4}{hellgruen}{Hörsaal 3 (0\textquotesingle 119)}
}

% abstract at HS 4
\DeclareRobustCommand*{\abstractHSvier}[4]%
{%
  \setAbstract{#1}{#2}{#3}{#4}{dezentrot}{HS 4 | Demo (0\textquotesingle 313)}
}

% abstract at Expert:innen | BoF | Anwender (1306)
\DeclareRobustCommand*{\abstractExpBoFAnw}[4]%
{%
  \setAbstract{#1}{#2}{#3}{#4}{audimax}{Exp. | BoF | Anw. (1\textquotesingle 306)}

}
% abstract at Anwendertreffen | BoF (1307)
\DeclareRobustCommand*{\abstractAnwBoF}[4]%
{%
  \setAbstract{#1}{#2}{#3}{#4}{eins}{Anwend. | BoF (1\textquotesingle 307)}
}
