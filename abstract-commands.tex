...
{%
  \setAbstract{#1}{#2}{#3}{#4}{geoblau}{Hörsaal 1 (01\textquotesingle 15)}
}

% abstract at HS 2
\DeclareRobustCommand*{\abstractHSzwei}[4]%
{%
  \setAbstract{#1}{#2}{#3}{#4}{hellgelb}{Hörsaal 2 (01\textquotesingle 10)}
}

% abstract at HS 3
\DeclareRobustCommand*{\abstractHSdrei}[4]%
{%
  \setAbstract{#1}{#2}{#3}{#4}{hellgruen}{Hörsaal 3 (01\textquotesingle 19)}
}

% abstract at HS 4
\DeclareRobustCommand*{\abstractHSvier}[4]%
{%
  \setAbstract{#1}{#2}{#3}{#4}{dezentrot}{HS 4 | Demo (03\textquotesingle 13)}
}

% abstract at Expert:innen | BoF | Anwender (1306)
\DeclareRobustCommand*{\abstractExpBoFAnw}[4]%
{%
  \setAbstract{#1}{#2}{#3}{#4}{audimax}{Exp. | BoF | Anw. (13\textquotesingle 06)}

}
% abstract at Anwendertreffen | BoF (1307)
\DeclareRobustCommand*{\abstractAnwBoF}[4]%
{%
  \setAbstract{#1}{#2}{#3}{#4}{eins}{Anwend. | BoF (13\textquotesingle 07)}
}
