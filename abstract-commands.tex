...
{%
  \setAbstract{#1}{#2}{#3}{#4}{geoblau}{HS 1 (Audimax I)}
}

% abstract at HS 2
\DeclareRobustCommand*{\abstractHSzwei}[4]%
{%
  \setAbstract{#1}{#2}{#3}{#4}{hellgelb}{HS 2 (Dietze H016)}
}

% abstract at HS 3
\DeclareRobustCommand*{\abstractHSdrei}[4]%
{%
  \setAbstract{#1}{#2}{#3}{#4}{hellgruen}{HS 3 (K0506/Audimax II)}
}
