...
\noindent\begin{tabular}{lZ{2.0cm}Z{2.0cm}Z{2.0cm}}
  ...
  \tabularnewline
  15:30
  \talk{QGIS im Produktivbetrieb}{Thomas \mbox{Baumann}}
  ...
  \tabularnewline
  16:00
  \talk{Web-GIS\linebreak
    kleiner Gemeinden mit QGIS-Server und Lizmap}{Günter Wagner}
    \talk{FAIRe Daten und FAIRe Software\linebreak in der Bio\-diversitäts\-forschung}{Bernhard \mbox{Seeger}}
...
\begin{center}
  ...
  & \multicolumn{1}{c}{\cellcolor{hellgruen} Weismannhaus}
    ...
    Einführung zu GDAL/OGR: Geodaten mit der Kommandozeile verarbeiten}{Jakob Miksch}
