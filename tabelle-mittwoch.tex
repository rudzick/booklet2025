...
\noindent\begin{tabular}{Z{0.85cm}Z{6.85cm}}
  & \multicolumn{1}{c}{\cellcolor{hellgelb} HS Anatomie}
  \tabularnewline
  10:30
...
\noindent\begin{tabular}{Z{0.85cm}Z{6.85cm}}
  & \multicolumn{1}{c}{\cellcolor{geoblau} HS Rundbau} \tabularnewline
  13:00
...
\noindent\begin{tabular}{lZ{2.0cm}Z{2.0cm}Z{2.0cm}}
  & \multicolumn{1}{c}{\cellcolor{geoblau} HS Rundbau}
  & \multicolumn{1}{c}{\cellcolor{hellgelb} HS Anatomie}
  & \multicolumn{1}{c}{\cellcolor{hellgruen} HS Weismannhaus}
  \tabularnewline
  15:00
  ...
  \talk{Weniger ist mehr - zur Auswahl darzustellender Elemente in der digitalen Kartographie}{Christoph Hormann}
  \tabularnewline
  15:30
  ...
  \talk{Umgang mit vorhandenen und fehlenden Relevanzinformationen in OpenStreetMap-Kartenstilen}{Michael Reichert}
  \tabularnewline
  16:00
