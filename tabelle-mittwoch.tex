...
\noindent\begin{tabular}{Z{0.7cm}Z{6.85cm}}
  ...
  \tabularnewline
 10:50
  \talk{Einsatz von Open Data und Open Source in HH - Eine erfolgsversprechende Strategie!}{Thomas Eichhorn}
  \tabularnewline
  11:15
...
\tabularnewline
  ...
  \talk{Monitoring von Waldgebieten mit Hilfe von Sentinel-2 abgeleiteten Vegetationsidizes}{Markus Eichhorn}
    \tabularnewline
  17:40
  \longTalk{2}{Podiumsdiskussion: Nachhaltige Beschaffung mit Blick auf Open Source}{Miriam Seyffarth, Pierre Golz, Anna Zagorski, Andreas Reckert-Lodde, Moderation: Niklas Alt}
