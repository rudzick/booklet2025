 ...
 % voffset=10mm,%
  ...
  contents={%
    \begin{tikzpicture}[x=1mm, y=1mm]%
      % map image
      \draw (0,0) node [inner sep=0mm, anchor=south west] {%
%        \includegraphics[width=148mm,angle=90,origin=c]{images-print/2025-03-02_Karte_Muenster.png}%
        \includegraphics[width=154mm,angle=90,origin=c]{images-print/2025-03-02_Karte_Muenster.png}%
      };%
      \end{tikzpicture}%
   }%
